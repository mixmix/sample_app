    ...
    describe "for non-signed-in-users" do 
      ...
      describe "in the Microposts controller" do
        describe "submitting to the create action" do
          before { post microposts_path } #POST request hits the create action in controller
          specify { response.should redirect_to(signin_path) }
        end
        
        describe "submitting to the destroy action" do
          before { delete micropost_path(FactoryGirl.create(:micropost)) } #DELETE request hits the destroy action in controller
          specify { response.should redirect_to(signin_path) }
        end
      end
      ...
      describe "in the Users controller" do 
        ...
        describe "submitting to the update action" do 
          before { put user_path(user) } #this issues put request to browser (capybara/ browser can't do this directly)
          specify { response.should redirect_to(signin_path) }
        end 
